...
public class gastos_fijos {
    ...
    private void initialize() {
        ...
        total_gastos_label.setForeground(Color.WHITE);
    ...
    private void saveGasto(String tipo, double monto) {
        // Usa `.` en lugar de `,` para el formato del archivo
        String gastoEntry = String.format("%s:%.2f", tipo, monto).replace(",", ".");
        ...
        try (BufferedWriter fw = new BufferedWriter(new FileWriter(GASTOS_FILE, false))) {
